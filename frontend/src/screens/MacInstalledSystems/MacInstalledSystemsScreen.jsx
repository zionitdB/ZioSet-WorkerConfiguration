...
const MacInstalledSystemsScreen = () => {
  ...
  //   let url = `mac-installed-systems/delete-by-system-serial-number?serialNumber=${serialNumber}`;
  ...
  return (
    <div className="container">
      <div className="text">Installed Systems - MAC OS</div>
...
export default MacInstalledSystemsScreen;
