// // PremiumDashboardWithSidebar.tsx
...
// // -----------------------------
// // const sidebarItems = [
// //   { name: "Dashboard", icon: Home, route: "/dashboard", permission: "view_dashboard" },
// //   { name: "Settings", icon: Settings, route: "/settings", permission: "view_settings" },
// // ];

// // Simulated user permissions
// // const userPermissions = ["view_dashboard", "view_settings"];

// // -----------------------------
// // Stats Data
// // -----------------------------
// const statsData = [
//   { title: "Total Agents", value: 485, change: "+12%", icon: Cpu, trend: "up" },
//   { title: "Active Scripts", value: 42, change: "+8%", icon: Zap, trend: "up" },
//   { title: "Config Issues", value: 8, change: "-3%", icon: Bug, trend: "down" },
//   { title: "System Uptime", value: "99.9%", change: "+0.2%", icon: Activity, trend: "up" },
// ];
...
//   { name: "Agent Configuration", icon: Settings, route: "/agentManagement/dashboard", description: "Configure agent settings" },
//   { name: "Agent Installation", icon: ListChecks, route: "/agentManagement/dashboard", description: "Run compliance system" },
//   { name: "Script Runner", icon: MonitorPlay, route: "/agentManagement/dashboard", description: "Execute and manage scripts" },
//   { name: "Access Control", icon: FileText, route: "/accessManagement/role", description: "View Access Control" },
//   { name: "User Management", icon: Users, route: "/agentManagement/dashboard", description: "Manage user accounts" },
//   { name: "Reports", icon: BarChart3, route: "/agentManagement/dashboard", description: "Generate analytics & reports" },
//   { name: "Security Center", icon: Shield, route: "/agentManagement/dashboard", description: "Security monitoring" },
// ];
...
//   return (
//     <div className="flex min-h-screen p-4 bg-background">

//       {/* <div className={`flex flex-col bg-background text-primary transition-all duration-300 ${sidebarOpen ? "w-48" : "w-16"}`}>
//         <button
//           className="p-2 m-2 rounded-lg bg-background hover:bg-primary/30 transition-colors"
...
//                 className="flex items-center gap-3 p-2 rounded-lg hover:bg-primary/20 transition-colors"
//               >
...
//                <span className="text-4xl font-extrabold tracking-tight bg-gradient-to-r from-primary to-primary/50 bg-clip-text text-transparent">Zioset</span> Management Console
//             </h1>
...
//             <Card
//               key={stat.title}
//               className="border shadow-sm hover:shadow-xl backdrop-blur-sm bg-card/80 transition-all duration-300"
//             >
...
//                   className="flex items-start gap-3 p-4 rounded-lg border bg-card hover:bg-accent hover:border-primary transition-all
//                              duration-200 text-left group shadow-sm hover:shadow-md"
//                 >
...
//                   <Area type="monotone" dataKey="active" stroke="hsl(var(--primary))" strokeWidth={2} fill="url(#activeGradient)" name="Active Agents" />
//                   <Area type="monotone" dataKey="offline" stroke="#ef4444" strokeWidth={2} fill="url(#offlineGradient)" name="Offline Agents" />
//                 </AreaChart>
//               </ResponsiveContainer>
//             </CardContent>
//           </Card>
...
//                 <div
//                   key={activity.id}
//                   className="flex items-start gap-3 p-3 rounded-lg hover:bg-muted/50 transition-colors shadow-sm"
//                 >
...
// Quick Access Modules
// const quickAccessModules = [
//   { name: "Agent Configuration", icon: Settings, route: "/agentManagement/dashboard", description: "Configure agent settings", color: "blue" },
//   { name: "Agent Installation", icon: ListChecks, route: "/agentManagement/dashboard", description: "Run compliance system", color: "violet" },
//   { name: "Script Runner", icon: MonitorPlay, route: "/agentManagement/dashboard", description: "Execute and manage scripts", color: "cyan" },
//   { name: "Access Control", icon: FileText, route: "/accessManagement/dashboard", description: "View Access Control", color: "amber" },
//   { name: "User Management", icon: Users, route: "/agentManagement/dashboard", description: "Manage user accounts", color: "emerald" },
//   { name: "Reports", icon: BarChart3, route: "/agentManagement/dashboard", description: "Generate analytics & reports", color: "pink" },
//   { name: "Security Center", icon: Shield, route: "/agentManagement/dashboard", description: "Security monitoring", color: "red" },
// ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative z-10 p-4 sm:p-6 lg:p-8">
        ...
        <div className="mb-8   p-6">
          ...
          {/* Quick Access Modules */}
        <Card className="shadow-sm border-border/50 mb-8 backdrop-blur-sm bg-card/80">
