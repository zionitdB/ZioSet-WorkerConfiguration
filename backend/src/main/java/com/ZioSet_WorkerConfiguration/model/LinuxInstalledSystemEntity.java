...
@Entity
@Table(name = "linux_installed_systems")
public class LinuxInstalledSystemEntity {
    @Id
    ...
    public LinuxInstalledSystemEntity() {
    }

    public LinuxInstalledSystemEntity(long id, String uuid, String systemSerialNo, boolean installed, LocalDateTime installedAt, LocalDateTime installReqAt, String installationResponse) {
        this.id = id;
        this.uuid = uuid;
