...
import WindowInstalledSystemsRoute from "./WindowsInstalledSystem";
import MacInstalledSystemsRoute from "./MACInstallSystem";
...
export default function InstalledSystemScreen() {
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-border/40">
           <TabsList className="relative h-11 w-full max-w-100 bg-transparent p-0 justify-start gap-6 border-none ring-0"> <TabButton 
                value="os" 
                label="Window Installed System" 
                Icon={Terminal} 
                isActive={activeTab === "os"} 
              />
              <TabButton 
                value="mac" 
                label="Mac Installed System" 
                Icon={Settings2} 
          ...
          <div className="mt-8">
            <AnimatePresence mode="wait">
              ...
              >
                <TabsContent value="os" className="mt-0 ring-offset-background focus-visible:outline-none">
                  <WindowInstalledSystemsRoute />
          
                </TabsContent>

                <TabsContent value="mac" className="mt-0 ring-offset-background focus-visible:outline-none">
                  <MacInstalledSystemsRoute />
